		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsappollutiontracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsappollutiontracker-display": {
								"semanticObject": "comsappollutiontracker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.pollutiontracker",
									"url": sap.ui.require.toUrl("com/sap/pollutiontracker")
								}
							}
						}
					}
